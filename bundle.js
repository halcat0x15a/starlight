...
var Idol = exports.Idol = function () {
  function Idol(name, type, rarity, life, vocal, dance, visual, effect) {
  ...
  _createClass(Idol, [{
    ...
    key: 'isRare',
    value: function isRare() {
      return this.rarity === 'R';
    }
  }, {
    key: 'isSRare',
    value: function isSRare() {
...
var IdolUnit = exports.IdolUnit = function () {
  ...
  _createClass(IdolUnit, [{
    ...
    key: 'life',
    value: function life() {
      return this.members().reduce(function (n, idol) {
        return n + idol.life;
      }, 0);
    }
  }, {
    key: 'vocal',
    value: function vocal() {
      return this.members().reduce(function (n, idol) {
        return n + idol.vocal;
      }, 0);
    }
...
var IdolTable = exports.IdolTable = function () {
  ...
  _createClass(IdolTable, [{
    key: 'filter',
    value: function filter(isCute, isCool, isPassion, isNormal, isRare, isSRare, isSSRare) {
      var testType = function testType(idol) {
        return idol.isCute() ? isCute : idol.isCool() ? isCool : idol.isPassion() ? isPassion : false;
      };
      var testRarity = function testRarity(idol) {
        return idol.isNormal() ? isNormal : idol.isRare() ? isRare : idol.isSRare() ? isSRare : idol.isSSRare() ? isSSRare : false;
      };
    ...
    key: 'sort',
    value: function sort(get, desc) {
      var compare = desc ? function (x, y) {
        return get(y) - get(x);
      } : function (x, y) {
        return get(x) - get(y);
      };
    ...
    value: function unit() {
      ...
      try {
        for (var _iterator = this.idols[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var center = _step.value;

          var centerEffect = Effects.get(center.effect);
          var _iteratorNormalCompletion2 = true;
          var _didIteratorError2 = false;
          var _iteratorError2 = undefined;

          try {
            for (var _iterator2 = guests[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
_reactDom2.default.render(_react2.default.createElement(view.App, null), document.getElementById('container'));

},{"./view":160,"react":158,"react-dom":29}],160:[function(require,module,exports){
'use strict';
...
var IdolTable = function (_React$Component2) {
  ...
  _createClass(IdolTable, [{
    ...
    value: function data() {
      ...
      return this.state.data.filter(function (idol) {
        return _this4.checkType(idol) && _this4.checkRarity(idol);
      });
    }
  }, {
    key: 'sort',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { type: 'checkbox', ref: 'cute', defaultChecked: true }),
              ' キュート'
            ),
            _react2.default.createElement(
              'label',
              { className: 'checkbox-inline' },
              _react2.default.createElement('input', { type: 'checkbox', ref: 'cool', defaultChecked: true }),
              ' クール'
            ),
            _react2.default.createElement(
              'label',
              { className: 'checkbox-inline' },
              _react2.default.createElement('input', { type: 'checkbox', ref: 'passion', defaultChecked: true }),
              ' パッション'
            ),
            _react2.default.createElement(
              'label',
              { className: 'checkbox-inline' },
              _react2.default.createElement('input', { type: 'checkbox', ref: 'normal', defaultChecked: true }),
              ' ノーマル'
            ),
            _react2.default.createElement(
              'label',
              { className: 'checkbox-inline' },
              _react2.default.createElement('input', { type: 'checkbox', ref: 'rare', defaultChecked: true }),
              ' レア'
            ),
            _react2.default.createElement(
              'label',
              { className: 'checkbox-inline' },
              _react2.default.createElement('input', { type: 'checkbox', ref: 'srare', defaultChecked: true }),
              ' Sレア'
            ),
            _react2.default.createElement(
              'label',
              { className: 'checkbox-inline' },
              _react2.default.createElement('input', { type: 'checkbox', ref: 'ssrare', defaultChecked: true }),
              ' SSレア'
            )
          )
        ),
